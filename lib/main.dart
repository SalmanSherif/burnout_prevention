...
import 'primarycards.dart';
import 'navdrawer.dart';
import 'package:intl/date_symbol_data_local.dart';
import 'steadiEvent.dart';
...
Widget MainView(){
  ...
  dbHelper.insert(new CustomEvent(1, "test_event", "test_description", DateTime.now(),
  3.0, "None", false, false, DateTime.now(), DateTime.now()));
                ...
                child: ListView.builder(scrollDirection: Axis.vertical,
                    ...
                    itemBuilder: (context, index){
                      return InkWell(
                          ...
                          showGeneralDialog(
                              ...
                              pageBuilder: (BuildContext buildContext,
                                ...
                                return Align(
                                  ...
                                  child: new SteadiEvent(eventName: "test"),
                                );
                              },
                        ...
                        child: PrimaryCards().textCard(),);
                    }),
              )
            ],
          ),
        ),
        //new SteadiEvent(eventName: "Checking Buddy!"),
      ],
    ),
  );
}
...
class SecondRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: new MyHomePage(title: 'Steadi V1'),
    );
  }
}
